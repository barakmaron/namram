...
const CableCutting = () => {
  ...
  return (<>
    <div className='flex justify-center bg-cable bg-fixed bg-cover py-16 shadow-inner bg-center'>
        <h2 className='text-8xl text-white font-bold pt-60 pb-24 '>ניסור בטון בכבל יהלום</h2>
    </div>
    <div className='py-10 mx-auto flex flex-col items-center' dir='rtl'>
        <h3 className='text-green-600 text-5xl font-bold py-4'>החברה המובילה לניסור בטון בכבל יהלום</h3>
